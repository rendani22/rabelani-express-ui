...
export class NavItemComponent {
  ...
  getIconSvg(): string {
    const icons: Record<string, string> = {
      ...
      wallet: `<rect x="2" y="4" width="20" height="16" rx="2"/><path d="M12 10v4"/><path d="M2 10h20"/>`,
      campaigns: `<path d="M22 12h-4l-3 9L9 3l-3 9H2"/>`,
      shipments: `<path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>`,
    ...
    return icons[this.icon] || icons['overview'];
  }
}
